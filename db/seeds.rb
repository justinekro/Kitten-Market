...
Item.create(title:"Pouliche", description: "Cette petite merveille adore les gratouilles", price:"7€", image_url:"kitten_6.jpg")
Item.create(title:"Foufoune", description: "Foufoune, la plus coquine des petites chates", price:"8€", image_url:"kitten_7.jpg")
Item.create(title:"Pitchoune", description: "Un petit trésor à poil", price:"5€", image_url:"kitten_8.jpg")
Item.create(title:"Crapule", description: "Elle fait plein de bêtises mais c'est un trésor", price:"6€", image_url:"kitten_9.jpg")
Item.create(title:"Noisette", description: "Attention, piège !!! C'est un chiot lol", price:"7€", image_url:"kitten_10.jpg")
Item.create(title:"Craspouille", description: "Une mimi cracra en puissance", price:"8€", image_url:"kitten_11.jpg")
Item.create(title:"Amour", description: "Un amour de chat", price:"5€", image_url:"kitten_12.jpg")
Item.create(title:"Félix", description: "Félix le chat", price:"7€", image_url:"kitten_13.jpg")
